...
* 为[添加了将部分自动转换为片段](convert-existing-forms-to-adaptive-forms.md)的功能，以帮助提高转换表单的渲染速度，并使在自适应表单编辑器中加载大型表单变得更容易。
...
在将源表单转换为自适应表单时，改进了将表单内容组织为选择组和字段的过程。

## 2021年2月02日(AFC-2021.01.2) {#feb-2021}

### 改进内容 {#feb-2021-improvements}

在将源表单转换为自适应表单时，改进了将表单内容组织到面板以及为面板生成标题的功能。
