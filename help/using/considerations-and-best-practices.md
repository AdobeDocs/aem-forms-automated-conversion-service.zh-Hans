...
<table border="1" cellpadding="1" cellspacing="0" style="border-collapse: separate; border-spacing: 0px;" width="100%"> 
 <tbody>
  ...
  <tr>
   <td><p><strong>图案</strong></p> <p>具有虚线或不清除边界和边框的表格不会进行转换。</p> <p><strong>解决方法</strong></p> <p>使用具有明确边界和边框的表。 受支持。</p> </td> 
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   <td width="25%"><p><strong>图案</strong></p> <p>服务无法识别没有明确边框的字段。</p> <p> </p> <p><strong>解决方法</strong></p> <p>使用“检查并更正”编辑器标识此类字段。</p> <p> </p> <p> </p> </td> 
   <td width="50%"><br /> <img src="assets/fields-without-clear-borders.png" /></td> 
  </tr>
  <tr>
   <td><p><strong>图案</strong></p> <p>服务将某些表单字段的底部或右侧带有标题未识别。</p> <p> </p> <p><strong>解决方法</strong></p> <p>使用“检查并更正”编辑器标识此类字段</p> </td> 
  ...
  <tr>
   <td><p><strong>图案</strong></p> <p>服务可能无法识别包含遥远字幕的字段或字幕与输入字段之间的虚线。</p> <p> </p> <p><strong>解决方法</strong></p> <p>使用具有明确边界的表单字段，或使用审阅和更正编辑器修复此类问题。</p> </td> 
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   <td><p><strong>图案</strong></p> <p>包含表单字段的列表会合并或不会转换为相应的自适应表单组件</p> <p><strong>解决方法</strong></p> <p>使用具有明确边界的表单字段，或使用审阅和更正编辑器修复此类问题。</p> </td> 
  ...
  <tr>
   <td><p><strong>图案</strong></p> <p>服务将某些包含选择组的列表相互合并</p> <p><strong>解决方法</strong></p> <p>使用审阅和修正编辑器可修复此类问题。</p> </td> 
